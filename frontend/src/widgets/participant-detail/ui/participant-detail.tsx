...
import {Award, Briefcase, MessageCircle, User} from "lucide-react";
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <img
                                            ...
                                            onError={(e) => {
                                                e.currentTarget.src = 'https://via.placeholder.com/48?text=S';
                                            }}
                                        />
                                        ...
                                        {stamp.isCollected ? (
                                            <Badge className="bg-red-500 text-white text-xs">取得済</Badge>
                                        ) : (
